...
public class AdjustLLManager extends LinearLayoutManager {
    ...
    public AdjustLLManager(Context context) {
        super(context);
    }

    @SuppressWarnings("UnusedDeclaration")
    public AdjustLLManager(Context context, int orientation, boolean reverseLayout) {
...
//        super.measureChildWithMargins(view, 0, 0);
        ...
        if (view != null) {
            ...
            //TODO 查一下这个recycler.recycleView(View v)....
